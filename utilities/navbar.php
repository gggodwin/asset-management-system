          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
              ...
              <script>
                  function updateManilaTime() {
                    const options = { timeZone: "Asia/Manila", weekday: "long", year: "numeric", month: "long", day: "numeric", hour: "numeric", minute: "numeric", second: "numeric" };
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(../../static/default.png)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div><?php echo $_SESSION['name']; ?></div>
                  <div class="mt-1 small text-secondary"><?php echo $_SESSION['position']; ?></div>
                </div>
              </a>
